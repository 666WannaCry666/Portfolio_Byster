jQuery(document).ready(function() {
    ...
    $.i18n().load({
        'en': {
          ...
          "header_link-devs": "For developers",
          "intro__title": "Byster - Auto PvE Bot",
          "intro__text": "Byster is a multifunctional PvE bot that has many features. Byster can heal, tank, and dish out maximum DPS. Tracks your procs, uses trinkets, professions, saves, changes the rotation depending on the priority and phase of the boss. Autobuff functions, AoE and solo modes, bursts and saves, auto-unequip weapons on MC, dispels, purges and much more, are you interested? Click on the button below!",
          ...
          "advantage__name-protection__text": "Unique protection from Warden Anticheat, we will not allow your account to be banned. Zero bans in 2 years!",
        ...
        'ru': {
          ...
          "advantage__name-protection__text": "Уникальная защита от античита Warden, не позволит забанить ваш аккаунт. Ноль банов за 2 года!",
