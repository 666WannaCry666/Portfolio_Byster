jQuery(document).ready(function() {
    ...
    $.i18n().load({
        'en': {
            ...
            "instruction__text-3": "After you have successfully registered with Byster, you need to write to us in private messages.",
        ...
        'ru': {
            ...
            "instruction__text-3": "После того как вы успешно зарегистрировались в Byster'е, вам необходимо написать нам в личные сообщения.",
